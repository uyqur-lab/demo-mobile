...
void main() {
  test('CU-DEMO001 AC-4: summa uch xonali guruhlar bilan formatlanadi', () {
  ...
  test('CU-DEMO001 AC-4: manfiy summa minus bilan ko`rsatiladi', () {
    expect(PriceFormatter.format(-45000), "-450 so'm");
  });

  test('CU-DEMO001 AC-4: bo`sh yoki noto`g`ri matnda fromPrice null qaytaradi, crash qilmaydi', () {
  ...
  test('CU-DEMO001 AC-4: fromPrice haqiqiy summani tiyinga aylantiradi', () {
